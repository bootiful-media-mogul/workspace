...
void main(String[] args) throws Exception {
    ...
    try (var ex = Executors.newCachedThreadPool()) {
        ...
        var repositories = ("clip gateway client api workspace pipeline media-processor github-actions-setup-jvm-build-env github-actions-setup-container-build-env")
                .split(" ");
